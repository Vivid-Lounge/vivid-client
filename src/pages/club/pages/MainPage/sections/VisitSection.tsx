...
const VisitSection: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Typography color="#ffffff" fontSize={36} fontWeight={"bold"} width={"max-content"}>VISIT US</Typography>
                ...
                >
                    ...
                    >
                        <Stack sx={{ display: "flex", flexDirection: "row", gap: "16px", alignItems: "center" }}>
                            ...
                            <Typography sx={{ fontSize: '20px', fontWeight: 'light' }}>Bld Profesor Dimitrie Mangeron Nr 71, Iași</Typography>
                        </Stack>
                        <Divider
                            sx={{
                                borderColor: "#1d1d1d",
                        ...
                        <Stack sx={{ display: "flex", flexDirection: "row", gap: "16px", alignItems: "center" }}>
                            ...
                            <Typography sx={{ fontSize: '20px', fontWeight: 'light' }}>vividlounge@gmail.com</Typography>
                        </Stack>
                        <Divider
                            sx={{
                                borderColor: "#1d1d1d",
                        ...
                        <Stack sx={{ display: "flex", flexDirection: "row", gap: "16px", alignItems: "center" }}>
                            ...
                            <Typography sx={{ fontSize: '20px', fontWeight: 'light' }}>0755.334.826</Typography>
                        </Stack>
